...
optimise_network = Optimisation(quantum_network, ideal_gate, "qha4_xxyyzz_de_output_vectorised2_approx")
...
bounds = [[-20, 20] for params in range(quantum_network.number_of_params())]

''' Number of processors to run over '''
number_of_processors = 4

''' Optimise Network '''
optimise_network.optimise_de(average_gate_fidelity_function, bounds, number_of_processors)
