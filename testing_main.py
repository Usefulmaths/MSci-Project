...
print(differential_evolution(average_fidelity, 10000, 8, len(interactions)*len(combination_of_interactions) + N * len(spin_matrices), 0.5, 0.5, [-1.2, 1.2], [-5, 5], "avg_fid QHA", -0.99, True))
